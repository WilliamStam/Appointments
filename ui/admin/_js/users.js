...
$(document).ready(function () {
	...
	$(document).on("submit", "#form", function (e) {
		...
		$.post("/admin/save/users/form?ID=" + ID, data, function (result) {
			result = result.data;
	...
	$(document).on("click", "#btn-delete-record", function (e) {
		...
		if (confirm("Are you sure you want to delete this record?")){
			$.post("/admin/save/users/delete?ID=" + ID, {}, function (result) {
				result = result.data;
...
function getForm() {
	...
	$.getData("/admin/data/users/form", {"ID": ID}, function (data) {
...
function getList() {
	...
	$.getData("/admin/data/users/_list", {"ID": ID, "search": search}, function (data) {
