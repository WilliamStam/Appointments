...
$(document).ready(function () {
	...
	$(document).on("submit", "#form", function (e) {
		...
		$.post("/admin/save/products/form?ID=" + ID, data, function (result) {
			result = result.data;
	...
	$(document).on("click", "#btn-delete-record", function (e) {
		...
		if (confirm("Are you sure you want to delete this record?")){
			$.post("/admin/save/products/delete?ID=" + ID, {}, function (result) {
				result = result.data;
...
function getForm() {
	...
	$.getData("/admin/data/products/form", {"ID": ID}, function (data) {
...
function getList() {
	...
	$.getData("/admin/data/products/_list", {"ID": ID, "search": search}, function (data) {
